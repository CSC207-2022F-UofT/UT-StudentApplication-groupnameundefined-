...
//            JComboBox<String> = new JComboBox<String>(parent.getUserSchema().getFriends());
            JComboBox<Long> jcbFriends = new JComboBox<Long>(new Long[]{Long.valueOf(2), Long.valueOf(10)});
...
//                body.put("toId", (String) parent.findFriendByName(jcbFriends.getSelectedItem());
                body.put("toId", (Long) jcbFriends.getSelectedItem());
