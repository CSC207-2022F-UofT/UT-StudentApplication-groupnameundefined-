...
public class ShowMatchesPanel extends JPanel implements InitializablePanel, ActionListener {
   ...
   private final MatchesMenu matchesMenu = new MatchesMenu(this);
    ...
    @Autowired
    public ShowMatchesPanel(WebClient webClient, UserSchema userSchema,
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == jbHabits){
            ...
            matchBy = new String[]{"HABIT", "COURSE"};
        }
        Map<String, Object> body = new HashMap<>();
        body.put("studentProfileId", userSchema.getStudentProfile().getId());
        body.put("matchBy", matchBy);
        Mono<ArrayList<StudentProfileSchema>> response = webClient.post()
